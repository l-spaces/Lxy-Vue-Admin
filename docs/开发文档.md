...
Lxy-Vue-Admin 是基于 [Vben Admin 5](https://github.com/vbenjs/vue-vben-admin) 和 [Ant Design Vue Next](https://github.com/antdv-next/antdv-next) 开发的企业级中后台管理系统前端项目。该项目与 RuoYi-Vue-Plus 后端框架深度集成，提供了一套完整的前端解决方案。

**项目定位：**
- 企业级中后台管理系统前端框架
- 基于 Monorepo 架构的现代化前端项目
- 与 RuoYi-Vue-Plus 后端深度集成的前端实现

**对应后端版本：**
- 分布式版本：RuoYi-Vue-Plus 5.X 分支
- 微服务版本：RuoYi-Cloud-Plus 2.X 分支
...
| Ant Design Vue Next | 4.2.6 | 基于 Vue 3 的企业级 UI 组件库 |
